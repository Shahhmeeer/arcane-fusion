    ...
    <div className="text-gray-200">
      <section className="h-screen">
        <div className="flex h-full">
          <div className="flex-1 flex items-center justify-center flex-col space-y-5">
            <h1 className="text-5xl font-bold">Game 1</h1>
            <p className="max-w-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam eos reprehenderit officia illum debitis dicta laborum porro sunt eligendi vitae illo nulla provident temporibus libero, quas nisi obcaecati natus aperiam ratione assumenda? Dolor distinctio alias excepturi tempora tempore facilis autem in voluptatem, ex veritatis sapiente facere officiis, voluptatibus fugiat quos.</p>
            <button className="btn">View on Playstore</button>
          </div>
      ...
      <section className="h-screen">
        <div className="flex h-full">
          ...
          <div className="flex-1 flex items-center justify-center flex-col space-y-5">
            <h1 className="text-5xl font-bold">Game 2</h1>
            <p className="max-w-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam eos reprehenderit officia illum debitis dicta laborum porro sunt eligendi vitae illo nulla provident temporibus libero, quas nisi obcaecati natus aperiam ratione assumenda? Dolor distinctio alias excepturi tempora tempore facilis autem in voluptatem, ex veritatis sapiente facere officiis, voluptatibus fugiat quos.</p>
            <button className="btn">View on Playstore</button>
          </div>
        </div>
      ...
      <section className="h-screen">
        <div className="flex h-full">
          <div className="flex-1 flex items-center justify-center flex-col space-y-5">
            <h1 className="text-5xl font-bold">Game 3</h1>
            <p className="max-w-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam eos reprehenderit officia illum debitis dicta laborum porro sunt eligendi vitae illo nulla provident temporibus libero, quas nisi obcaecati natus aperiam ratione assumenda? Dolor distinctio alias excepturi tempora tempore facilis autem in voluptatem, ex veritatis sapiente facere officiis, voluptatibus fugiat quos.</p>
            <button className="btn">View on Playstore</button>
          </div>
          <div className="flex items-center justify-center flex-1">
