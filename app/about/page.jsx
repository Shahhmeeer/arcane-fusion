export default function About() {
  return (
    <main className="text-gray-200">
      <section className="flex" style={{ minHeight: "93dvh" }}>
        <div className="flex-1 flex justify-center items-center flex-col text-white">
      ...
      <section className="flex" style={{ minHeight: "93dvh" }}>
        <div className="flex-1 flex justify-center items-center flex-col text-white">
          <h1 className="text-3xl">Tecnologies We Use</h1>
          <p className="max-w-lg pseudo-partial-border">
      ...
      <section className="flex" style={{ minHeight: "93dvh" }}>
        <div className="flex-1 flex justify-center items-center flex-col text-white">
          ...
          <p className="max-w-lg pseudo-partial-border">
            Our team isn&apos;t your typical group of developers; we&apos;re wizards, conjuring magic through lines of code and spellbinding art. Led by our fearless
            sorcerer-in-chief, we&apos;re a diverse collective of passionate gamers, coding enchanters, and design alchemists. Together, we embark on quests to create worlds that
            gamers will want to inhabit, filled with challenges, surprises, and, of course, a sprinkle of arcane humor.
          </p>
          <div className="py-4"></div>
      ...
      <section className="flex" style={{ minHeight: "93dvh" }}>
        <div className="flex-1 flex justify-center items-center flex-col text-white">
          ...
          <p className="max-w-lg pseudo-partial-border">
            Arcane Fusion takes pride in offering a diverse array of services that cater to the intricate needs of the gaming industry. From concept design that feels like casting
            a magic spell to development processes that rival the precision of a wizard&apos;s incantation, our team is adept at working with both Unreal and Unity. We bring a touch
            of arcane finesse to every line of code and pixel of art, ensuring that our games not only meet industry standards but exceed the expectations of even the most
            discerning gamers.
          </p>
          <div className="py-4"></div>
          <button className="btn">View Services</button>
